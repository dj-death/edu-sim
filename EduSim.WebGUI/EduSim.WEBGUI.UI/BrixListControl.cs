...
namespace EduSim.WebGUI.UI
{
    ...
    public class BrixListControl : BaseUserControl, IHostedApplication
	{
        ...
        private void mobjListView_DoubleClick(object sender, EventArgs e)
        {
            ...
            //TODO: Need to associate the back button
		...
		private void InitializeComponent()
		{
            ...
            listDataSet = listModel.GetList(100, null, null, ref CurrentPage, out count);
        ...
        private void bindingNavigator1_ToolBarButtonClickEventHandler(object objButton, EventArgs objEvent)
        {
        }
