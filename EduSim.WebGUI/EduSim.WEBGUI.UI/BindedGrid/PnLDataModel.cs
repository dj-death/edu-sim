...
namespace EduSim.WebGUI.UI.BindedGrid
{
    ...
    public class PnLDataModel : RoundDataModel
    {
        public override void GetList(DataGridView dataGridView1)
        {
            ...
            AddRow((Dictionary<string, double>)GetSessionData("Revenue"), products, dataGridView1, "Sales Revenue");
            AddRow((Dictionary<string, double>)GetSessionData("LabourCost"), products, dataGridView1, "Labour Cost");
            AddRow((Dictionary<string, double>)GetSessionData("AutomationCost"), products, dataGridView1, "Automation Cost");
            AddRow((Dictionary<string, double>)GetSessionData("NewCapacityCost"), products, dataGridView1, "Plant Cost");
            AddRow((Dictionary<string, double>)GetSessionData("RnDCost"), products, dataGridView1, "R&D Cost");
            AddRow((Dictionary<string, double>)GetSessionData("SalesAndMarketingExpense"), products, dataGridView1, "S&M Cost");
        }
