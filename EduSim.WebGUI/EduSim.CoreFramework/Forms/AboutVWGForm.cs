...
namespace EduSim.CoreFramework.Forms
{
    ...
    public class AboutVWGForm : Form
	{
		...
		private void InitializeComponent()
		{
			...
			this.mobjPictureLogo.ClientSize = new System.Drawing.Size(382, 100);
			...
			this.mobjPictureLogo.Size = new System.Drawing.Size(382, 100);
			...
			@"Visual WebGui is a new approch for developing AJAX applications that lets you develop in WinForms like server side API (including designtime support) to create a full AJAX enabled highly complex applications like this application (without using HTML/JavaScript or any other web language)."};
