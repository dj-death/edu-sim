...
namespace EduSim.CoreFramework.DataControls
{
    ...
    [Serializable()]
    public class LabourDataGridView : UserControl, IHostedApplication
	{
        private DataGridView dataGridView1;
        private LabourDataModel rdm;
        ...
        public LabourDataGridView()
		{
			// This call is required by the WebGUI Form Designer.
			InitializeComponent();

            rdm = Activator.CreateInstance<LabourDataModel>();
